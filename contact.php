        ...
        <div id="main">
            ...
            <div id="content">
                ...
                <div class="left">
                    ...
                    <p>Masz pytanie lub ofertę? Skontaktuj się ze mną poprzez formularz:</p>
                ...
                <div class="left">
                    ...
                    <form method="post" action="send.php">
                        <input type="email" name="email" placeholder="Twój adres email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required><br>
